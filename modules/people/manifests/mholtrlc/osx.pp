# == Description
#
# OS X settings specific for Michael Holt.
#
class people::mholtrlc::osx {
  ...
  include people::mholtrlc::osx::trackpad::threeFingerDrag

  osx::recovery_message { 'If this Mac is found, please call 661-621-5555': }
